...
const Expand: React.FC<React.PropsWithChildren<ExpandProps>> = ({ isExpanded = false, delay = 200, children }: React.PropsWithChildren<ExpandProps>) => {
...
Expand.displayName = 'HimalayaExpand';
