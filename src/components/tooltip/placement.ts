...
export const getPosition = (placement: Placement, rect: ParentDomRect, offset: number): TooltipPosition => {
...
export const getIconPosition = (placement: Placement, offsetX: string, offsetY: string, offsetAbsolute: string = '3px'): TooltipIconPosition => {
