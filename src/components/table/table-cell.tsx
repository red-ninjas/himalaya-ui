...
const TableCell = <TableDataItem extends TableDataItemBase>({ columns, row, rowIndex, emptyText, onCellClick }: TableCellProps<TableDataItem>) => {
    ...
    <>
      {columns.map((column, index) => {
        ...
        return (
          ...
          >
            <div className="cell">{shouldBeRenderElement ? shouldBeRenderElement : cellValue}</div>
          </td>
        );
      })}
    </>
