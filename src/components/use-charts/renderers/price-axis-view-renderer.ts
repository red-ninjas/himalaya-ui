...
export class PriceAxisViewRenderer implements IPriceAxisViewRenderer {
  ...
  private _calculateGeometry(
    ...
    const paddingBottom =
      rendererOptions.paddingBottom + this._commonData.additionalPaddingBottom;
    ...
    const totalWidth =
      rendererOptions.borderSize + paddingInner + paddingOuter + textWidth + tickSize;
