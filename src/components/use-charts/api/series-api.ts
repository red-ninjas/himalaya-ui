...
export class SeriesApi<
    ...
    HorzScaleItem,
    TData extends
      WhitespaceData<HorzScaleItem> = SeriesDataItemTypeMap<HorzScaleItem>[TSeriesType],
    TOptions extends SeriesOptionsMap[TSeriesType] = SeriesOptionsMap[TSeriesType],
    TPartialOptions extends
      SeriesPartialOptionsMap[TSeriesType] = SeriesPartialOptionsMap[TSeriesType],
  >
  implements
    ...
    IDestroyable
{
  ...
  public markers(): SeriesMarker<HorzScaleItem>[] {
    return this._series
      .markers()
      .map<SeriesMarker<HorzScaleItem>>(
        (internalItem: SeriesMarker<InternalHorzScaleItem>) => {
