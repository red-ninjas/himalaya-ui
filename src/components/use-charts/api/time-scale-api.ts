...
export class TimeScaleApi<HorzScaleItem>
  implements ITimeScaleApi<HorzScaleItem>, IDestroyable
{
  ...
  private readonly _timeRangeChanged: Delegate<Range<HorzScaleItem> | null> =
    new Delegate();
