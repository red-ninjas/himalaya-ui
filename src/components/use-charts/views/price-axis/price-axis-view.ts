...
export abstract class PriceAxisView implements IPriceAxisView {
  ...
  public constructor(ctor?: IPriceAxisViewRendererConstructor) {
    this._axisRenderer = new (ctor || PriceAxisViewRenderer)(
      this._axisRendererData,
      this._commonRendererData,
    );
    this._paneRenderer = new (ctor || PriceAxisViewRenderer)(
  ...
  public renderer(priceScale: PriceScale): IPriceAxisViewRenderer {
    ...
    this._axisRendererData.tickVisible =
      this._axisRendererData.tickVisible && priceScale.options().ticksVisible;
    this._paneRendererData.tickVisible =
      this._paneRendererData.tickVisible && priceScale.options().ticksVisible;
