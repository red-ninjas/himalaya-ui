...
class SeriesPrimitivePaneViewWrapper implements IPaneView {
  ...
  private _cache: RendererCache<
    ISeriesPrimitivePaneRenderer,
    SeriesPrimitiveRendererWrapper
  > | null = null
...
export class SeriesPrimitiveWrapper<TSeriesAttachedParameters = unknown> {
  ...
  public paneViews(): readonly ISeriesPrimitivePaneViewWrapper[] {
    ...
    const wrapper = base.map(
      (pw: ISeriesPrimitivePaneView) => new SeriesPrimitivePaneViewWrapper(pw),
    )
  ...
  public timeAxisViews(): readonly ITimeAxisView[] {
    ...
    const wrapper = base.map(
      (aw: ISeriesPrimitiveAxisView) =>
        new SeriesPrimitiveTimeAxisViewWrapper(aw, timeScale),
    )
  ...
  public priceAxisViews(): readonly IPriceAxisView[] {
    ...
    const wrapper = base.map(
      (aw: ISeriesPrimitiveAxisView) =>
        new SeriesPrimitivePriceAxisViewWrapper(aw, priceScale),
    )
