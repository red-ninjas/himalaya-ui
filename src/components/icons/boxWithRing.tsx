  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 36">
        ...
        />
        <path stroke="var(--geist-foreground)" d="M6.48 9.24 21 16.5l14.52-7.26M21 34.14V30m0-13.5V21" />
        <path stroke="var(--geist-foreground)" d="m39 15.461 1.52.779L21 26 1.48 16.24 3 15.461" />
      </svg>
    </svg>
  );
};
