...
export const generateAccents = (mainColor: string, isTint): UIThemesAccents => {
  ...
  return {
    accents_0:
      '#' + (isTint ? mainColorConverter.tint(5).hex : mainColorConverter.shade(5).hex),
    accents_1:
      '#' + (isTint ? mainColorConverter.tint(10).hex : mainColorConverter.shade(10).hex),
    accents_2:
      '#' + (isTint ? mainColorConverter.tint(20).hex : mainColorConverter.shade(20).hex),
    accents_3:
      '#' + (isTint ? mainColorConverter.tint(30).hex : mainColorConverter.shade(30).hex),
    accents_4:
      '#' + (isTint ? mainColorConverter.tint(40).hex : mainColorConverter.shade(40).hex),
    accents_5:
      '#' + (isTint ? mainColorConverter.tint(60).hex : mainColorConverter.shade(60).hex),
    accents_6:
      '#' + (isTint ? mainColorConverter.tint(70).hex : mainColorConverter.shade(70).hex),
    accents_7:
      '#' + (isTint ? mainColorConverter.tint(80).hex : mainColorConverter.shade(80).hex),
    accents_8:
      '#' + (isTint ? mainColorConverter.tint(90).hex : mainColorConverter.shade(90).hex),
    border:
      '#' +
      (isTint ? mainColorConverter.tint(12).hex : mainColorConverter.shade(8.5).hex),
    secondary:
      '#' +
      (isTint ? mainColorConverter.tint(8.5).hex : mainColorConverter.shade(7.5).hex),
