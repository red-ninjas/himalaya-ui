...
export const createUIContext = <S extends Record<string, unknown>, N extends string>(
  name: N,
  initialStates: S,
) => {
  ...
  const UIContext = React.forwardRef<S, React.PropsWithChildren<UIContextProps>>(
  ...
  type ResultType = UINamedProvider<typeof UIContext, N> &
    UINamedContext<ContextStates<S>, N>;
