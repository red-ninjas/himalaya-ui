...
there are not a lot of complex class-names expressions to deal with in __Himalya__, just for regular space sign removal.
...
```tsx
import { useClasses } from '@himalaya-ui/core'
...
<Attributes component="useClasses" edit="/app/hooks/use-classes.mdx"></Attributes>