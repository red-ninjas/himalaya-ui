...
The Input contain an additional Hooks, see subsection [useInput](/hooks/use-input) for details.
...
<>
  ...
  <Input scale={4/3} placeholder="Scale 4/3" />  <Spacer h={.5} />
  <Input scale={{ xs: 1, md: 2, lg: 3, xl: 5 }} placeholder="Scale Responsive" />
</>
`}
/>
...
<Playground
  ...
  scope={{ Input }}
  code={`
<Input placeholder="Himalaya" w="100%" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Input label="username" placeholder="Himalya UI" />
  <Spacer h={.5} />
...
<>
  ...
  <Spacer />
  <Input placeholder="Post title" w="50%">
    <Text h3>Title</Text>
  </Input>
  <Spacer />
  <Input placeholder="GitHub Actions" w="50%">
    <Dot type="warning">
...
<Playground
  ...
  code={`
<>
  <Input type="secondary" initialValue="Himalya UI" />
  <Spacer h={.5} />
  <Input type="success" initialValue="Himalya UI" />
  <Spacer h={.5} />
  <Input type="warning" initialValue="Himalya UI" />
  <Spacer h={.5} />
  <Input type="error" initialValue="Himalya UI" />
</>
`}
/>
...
<Attributes edit="/app/components/input.mdx">
...
```ts
type InputTypes = 'default' | 'primary' | 'tertiary' | 'secondary' | 'success' | 'warning' | 'error';
```
