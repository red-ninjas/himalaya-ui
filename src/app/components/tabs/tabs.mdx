...
The Tabs contain an additional Hooks, see subsection [useTabs](/hooks/use-tabs) for details.
...
<Attributes edit="/app/components/tabs.mdx">
...
| **gap**              | gap between elements             | `CSSProperties`         | -                               | `0px`  |
