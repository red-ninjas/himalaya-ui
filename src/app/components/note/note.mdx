...
<Playground
  ...
  scope={{ Note }}
  code={`
<Note icon={false}>Just a quick note!</Note>
`}
/>
...
<Playground
  ...
  code={`
<>
  <Note  filled>This note uses a custom label.</Note>
  <br/>
  <Note label={false} filled>Just a quick note!</Note>
  <br/>
  <Note type="success"   filled>This note details a success.</Note>
  <br/>
  <Note type="warning"   filled>This note details a warning.</Note>
  <br/>
  <Note type="error"  filled>This note details an error.</Note>
  <br/>
...
```ts
type NoteTypes = 'default' | 'primary' | 'tertiary' | 'secondary' | 'success' | 'warning' | 'error'
```
