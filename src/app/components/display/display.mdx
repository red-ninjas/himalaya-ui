...
<Playground
  ...
  <Display shadow caption="An open-source design system for building modern websites and applications.">
    <Image width="435px" height="200px" src="/images/himalaya-banner.png" />
  </Display>
`}
/>
...
<Playground
  ...
  <Display shadow caption={<p>Browse <Code>himalaya-ui.com</Code> for more documentation.</p>}>
    <Image width="650px" height="297px" src="/images/himalaya-banner.png" />
  </Display>
`}
/>

<Attributes edit="/pages/components/display.mdx">
