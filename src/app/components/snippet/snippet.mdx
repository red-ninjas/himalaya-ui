...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet text="yarn add himalaya" width="300px" />
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet text="yarn add himalaya" width="100%" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Snippet text="yarn add himalaya" type="dark" width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="success" width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="warning" width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="error" width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="secondary" width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="lite" width="300px" />
</>
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet copy="prevent" text="yarn add himalaya" width="300px" />
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet symbol=">" text="yarn add himalaya" width="300px" />
`}
/>
...
<Playground
  ...
  scope={{ Snippet }}
  code={`
<Snippet toastText="Code copied!" toastType="secondary" text="yarn add himalaya" width="300px" />
`}
/>
...
<Playground
  ...
  code={`
<>
  <Snippet text="yarn add himalaya" type="success" filled width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="warning" filled width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="error" filled width="300px" />
  <Spacer />
  <Snippet text="yarn add himalaya" type="secondary" filled width="300px" />
</>
`}
/>
