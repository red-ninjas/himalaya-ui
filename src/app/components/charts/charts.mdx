...
import { Link, Text, Code, Button, ToggleList, Spacer,  GraphDataView } from 'components';
...
<Playground
  ...
  code={`() => {
      return (
          <Chart>
            <Chart.Line color='#0062d1' title="Test Line" data={[
              { value: 1, time: 1642425322 },
              { value: 8, time: 1642511722 },
              { value: 10, time: 1642598122 },
              { value: 20, time: 1642684522 },
            ...
            <Chart.Line color='#da2f35' title="Test Line 2" data={[
...
<Playground
  ...
  desc="A multi line chart example with different colors and legends"
  scope={{ Chart, Button, useState, ToggleList }}
  code={`() => {
      const min = 1;
      const max = 100;
      ...
      return (
          <>
            ...
            <Chart viewMode={dataViewMode}>
              <Chart.Line color='#0062d1' title={title} data={data} />
              {enabled && <Chart.Line color='#da2f35' title="Serie 2" data={data2} />}
              <Chart.Legends/>
              <Chart.DataView/>
            </Chart>
          </>
...
<Playground
  ...
  scope={{ Chart,  useRef, useEffect, createRef }}
  code={`() => {
...
<Attributes component="Charts" edit="/app/components/charts.mdx"></Attributes>