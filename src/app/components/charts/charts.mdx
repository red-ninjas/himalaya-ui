...
import { Link, Text, Code, Button, ToggleList, Spacer, useTheme, GraphDataView } from 'components';
...
<Playground
  ...
  code={`() => {
      ...
      return (
          <Chart>
            <Chart.Line color={theme.palette.primary.hex_1000} title="Test Line" data={[
              { value: 1, time: 1642425322 },
              { value: 8, time: 1642511722 },
              { value: 10, time: 1642598122 },
              { value: 20, time: 1642684522 },
            ...
            <Chart.Line color={theme.palette.error.hex_1000} title="Test Line 2" data={[
      ...
      return (
          <>
            ...
            <Chart viewMode={dataViewMode}>
              <Chart.Line color={theme.palette.primary.hex_1000} title={title} data={data} />
              {enabled && <Chart.Line color={theme.palette.error.hex_1000} title="Serie 2" data={data2} />}
              <Chart.Legends/>
              <Chart.DataView/>
            </Chart>
          </>
