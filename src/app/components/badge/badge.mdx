...
() => {
  ...
  return (
    <>
      <Badge style={{ backgroundColor: theme.palette.success.light }}>Success Light</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.success.dark }}>Success Dark</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.danger.value }}>Alert</Badge> <Spacer h={.5} />
      ...
      <Badge style={{ backgroundColor: theme.palette.tertiary.value, color: theme.tertiary.tertiary.contrast }}>Cyan Lighter</Badge> <Spacer h={.5} />
    </>
  )
}
`}
