...
() => {
  ...
  return (
    <>
      <Badge style={{ backgroundColor: theme.palette.success.hex_900 }}>Success Light</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.success.hex_1200 }}>Success Dark</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.error.hex_1000 }}>Alert</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.warning.hex_1000 }}>Purple</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.primary.hex_1000 }}>Violet</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.tertiary.hex_1000, color: theme.palette.tertiary.contrast }}>Cyan Lighter</Badge> <Spacer h={.5} />
    </>
  )
}
`}
...
<Attributes edit="/app/components/badge.mdx">
