...
() => {
  ...
  return (
    <>
      ...
      <Badge style={{ backgroundColor: theme.palette.error.value }}>Alert</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.warning.value }}>Purple</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.primary.value }}>Violet</Badge> <Spacer h={.5} />
      <Badge style={{ backgroundColor: theme.palette.tertiary.value, color: theme.palette.tertiary.contrast }}>Cyan Lighter</Badge> <Spacer h={.5} />
    </>
  )
}
`}
